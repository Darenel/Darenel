...
- Certifications: freeCodeCamp (JavaScript, Python, Responsive Web Design) · HackerRank (Software Engineer, React, JavaScript, SQL). Check it on [darenel.dev](https://darenel.dev)
